...
namespace BiblioTK.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ApplicationUser>().ToTable("Usuarios", "dbo").Property(p => p.LockoutEnabled).HasColumnName("Bloqueado");
            ...
            modelBuilder.Entity<ApplicationUser>()
                .HasRequired<Country>(s => s.CountryOfBirth)
                .WithMany(s => s.ApplicationUsersByCountryOfBirth)
                .HasForeignKey(s => s.CountryOfBirthID).WillCascadeOnDelete(false);
        ...
        public virtual DbSet<Country> Paises { set; get; }
        #endregion
    }
}